...
import bgImage from '../../assets/Untitled1.jpg'
...
const Local = () => {
  return (
   <main>
    <Helmet>
      <title>Local - Katrina Romulo</title>
    </Helmet>
  ...
  <div className='flex flex-col lg:flex-row w-full items-start gap-4 py-8 lg:py-18'>
    ...
    <div className='ml-0 lg:ml-[500px] flex flex-col items-start gap-4'>
      <h4 className='text-[18px] leading-[27px] text-[#000] font-sans'>Lifestyle Photographer: Shaira Luna 
        (assisted by Von Luna) <br />
Product Photographer: Alexis Wang</h4>
      <p className='text-[18px] leading-[27px] text-[#000] font-sans'>Models: <br /> Richa Mishra, Alay Modi, Ben Bacon</p>
      <p className='text-[18px] leading-[27px] text-[#000] font-sans'>Makeup: Leslie Zara <br />
Producer and Creative Director: Bea Jocom <br />
Styling: Bea Jocom <br />
Assistant Producer: Zoe Laurente <br />
Wardrobe: Kim Bigornia <br />
Videographer: Renzo Rosario</p>
<p className='text-[18px] leading-[27px] text-[#000] font-sans'>Web Design and Development: Odin & Grotesk Design Studio, Yello Studio</p>
<p className='text-[18px] leading-[27px] text-[#000] font-sans'>Copywriting: Isabella Argosino</p>
    </div>
  </div>
   </Section>
   </main>
